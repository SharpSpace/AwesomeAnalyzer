...
using VerifyCS = Analyzer1.Test.CSharpCodeFixVerifier<
    Analyzer1.MakeSealedAnalyzer,
    Analyzer1.MakeSealedCodeFixProvider>;
...
class Program
{ }",
                VerifyCS.Diagnostic().WithSpan(2,1,3,4), //DiagnosticResult.EmptyDiagnosticResults, // Verify.Diagnostic("Analyzer1").WithLocation(11, 15).WithArguments("TypeName"),
                fixedSource: @"
